    ...
    <div style={{ fontFamily: "'Inter', sans-serif", backgroundColor: '#0f1923', color: '#e2e8f0', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      <div className="hero">
        ...
        <div className="hero-content">
          <div className="badge">v1.0.5 STABLE</div>
            ...
            <div className="hero-btns">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-6 h-6">
                  <path fill="white" d="M96 96L310.6 96L310.6 310.6L96 310.6L96 96zM329.4 96L544 96L544 310.6L329.4 310.6L329.4 96zM96 329.4L310.6 329.4L310.6 544L96 544L96 329.4zM329.4 329.4L544 329.4L544 544L329.4 544L329.4 329.4z"/>
                </svg>
      ...
      <footer style={{ backgroundColor: '#0a1219', borderTop: '1px solid #1e2d3d', padding: '40px 48px 28px', marginTop: '80px', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '-8px', marginRight: '75%' }}>
