    ...
    <div style={{ fontFamily: "'Inter', sans-serif", backgroundColor: '#0f1923', color: '#e2e8f0', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      <nav>
        ...
        <div className="nav-right">
          <a href="https://discord.gg/nxsDcYVa6s" target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#5865F2', color: '#ffffff', padding: '8px 16px', borderRadius: '8px', textDecoration: 'none', fontSize: '14px', fontWeight: 600 }}
